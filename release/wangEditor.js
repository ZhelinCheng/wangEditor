...
Text.prototype = {
    ...
    _enterKeyHandle: function _enterKeyHandle() {
        ...
        function pHandle(e) {
            ...
            if (nodeName === 'FIGURE') {
                var _$p = $('<p></p>');
                var className = $selectionElem[0].className;
                var $selectionElems = $(document.querySelectorAll('.' + className));
                _$p.insertAfter($selectionElem);
                editor.selection.createRangeByElem(_$p, true);
                editor.selection.restoreSelection();

                console.log($selectionElems.get(0));

                // 获取图片说明
                var $children = $selectionElems.get(1).children().get(1);
